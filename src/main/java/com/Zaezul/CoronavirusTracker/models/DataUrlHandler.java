...
public class DataUrlHandler {
    ...
    private static String THIRTY_DAY_DATA_URL = "https://raw.githubusercontent.com/CSSEGISandData/COVID-19/master/css" +
            "e_covid_19_data/csse_covid_19_daily_reports/02-07-2023.csv";
    private static String PREVIOUS_DAY_DATA_URL = "https://raw.githubusercontent.com/CSSEGISandData/COVID-19/master/c" +
            "sse_covid_19_data/csse_covid_19_daily_reports/03-08-2023.csv";
    private static String CURRENT_DATA_URL = "https://raw.githubusercontent.com/CSSEGISandData/COVID-19/master/csse_co" +
            "vid_19_data/csse_covid_19_daily_reports/03-09-2023.csv";

    /**
     * The following commented code is deprecated as the data source has stopped updating.
     */
